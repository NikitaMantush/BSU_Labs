...
void main(int argc, char** argv) {
	...
	// ¬ыводим элементы массивов на консоль
	cout << "Array 1: ";
	...
	// —оздаем новый массив и заполн€ем его совпадающими элементами
	...
	for (int i = 0; i < new_arr_size; i++) {
		new_arr[i] = '0'; // заполн€ем новый массив нул€ми
	}
	int j = 0;
	for (int i = 0; i < arr1_size; i++) {
		if (isdigit(arr1[i])) {
	...
	// ¬ыводим новый массив на консоль
	cout << "New Array: ";
	for (int i = 0; i < j; i++) {
		cout << new_arr[i] << " ";
	}
